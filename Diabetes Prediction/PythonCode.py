...
def remove_outliers(data):
    data["Insulin"] = data["Insulin"] * 0.001
...
def plot_boxplots_after_transformations(data):
    ...
    plt.subplots_adjust(
        left=0.12, right=0.95, bottom=0.05, top=0.95, wspace=0.35, hspace=0.25
    )
    plt.subplot(2, 2, 1)
...
def metrics_line_plots(accuracies, specificity, sensitivity):
    ...
    plt.subplots_adjust(
        left=0.05, right=0.95, bottom=0.1, top=0.95, wspace=0.25, hspace=0.5
    )
    plt.plot(
